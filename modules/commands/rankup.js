...
let random = Math.floor(Math.random() * 7) + 1;
		...
		if (existsSync(__dirname + "/noprefix")) mkdirSync(__dirname + "/noprefix", { recursive: true });
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "『 {name} 』 لـقـد ارتــــفع مـسـتـواك بـي الـبوت واصبح level {level} بالفعل!! دعونا نصنع بعض الضوضاء",
	}
}
