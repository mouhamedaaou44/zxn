...
module.exports.config = {
  ...
  hasPermission: 0,
  credits: "ǺᎩᎧᏬᏰ",
  description: "ذكاء اصطناعي جوجل بحث+صور+صوت",
  usePrefix: true,
  commandCategory: "ai",
  usages: "<query>",
  cooldowns: 5,
...
module.exports.run = async function ({ api, event, args }) {
  ...
  api.sendMessage("🔎 جاري البحث يرجى الانتضار...", threadID, messageID);
  ...
  try {
    ...
    for (let i = 0; i < pinterestImageUrls.length; i++) {
      ...
      try {
        ...
        console.error("حدث خطأ أثناء جلب صورة Pinterest:", error);
      }
    }
